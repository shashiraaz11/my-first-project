...
# 🔗 Sheet IDs
# ==================================
source_ev_sheet_id = "1pq2VwJzF-YASo3VIIxHRW-SpuWD_mvAngZvTRcWGxkg"   # EV sheet
source_cng_sheet_id = "1jELPAsR-2zlz4182S7Byc5WmqtLa-ZYjIRD_hyRXBAo"  # CNG sheet
target_sheet_id = "1yDoXBuatVAep4z47L-WbSYvEELKZ3VOJm1CWwSQdWkU"      # Target sheet
...
# ==================================
def main():
    # Transfer from EV sheet → target “Combined EV”
    transfer_tab(source_ev_sheet_id, "Combined", "Combined EV", "A:AM")

    # Transfer from CNG sheet → target “Combined CNG”
    transfer_tab(source_cng_sheet_id, "Combined", "Combined CNG", "A:AM")

    # Log completion
    log_last_run("CNG+EV_Allocation_deallocation.py")
